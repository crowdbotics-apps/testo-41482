"""
Django settings for testo_41482 project.
...
WSGI_APPLICATION = 'testo_41482.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testo_41482 API",
    "DESCRIPTION": "API documentation for testo_41482 App",
    "VERSION": "v1",
}
